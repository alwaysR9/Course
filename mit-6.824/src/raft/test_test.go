...
func TestFigure8Unreliable2C(t *testing.T) {
	...
	fmt.Printf("Re-connect all servers ...\n")
	...
	fmt.Printf("Re-connect all servers finish .\n")
	fmt.Printf("add last cmd .\n")
